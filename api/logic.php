...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $senha = md5($_POST['senha']); // Mantenha o MD5, mas considere métodos de hash mais seguros como password_hash()
    ...
    if (empty($errors)) {
        ...
        if ($stmt_insert->execute()) {
            ...
            // Para depuração, você pode querer logar $stmt_insert->errorInfo()
        }
    }
